...
here::i_am("R/evaluate_sens_performance.R")
...
truth_file <- paste0("/projects/dbenkes/allison/shigella_vaccine_trial/truth/truth_", setting, ".Rds")
...
dir <- "/projects/dbenkes/allison/shigella_vaccine_trial/sens_results"
